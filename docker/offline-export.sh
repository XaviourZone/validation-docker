...
mkdir -p "$OUT_DIR/runtime/spool" "$OUT_DIR/runtime/router-state" "$OUT_DIR/runtime/router-logs" "$OUT_DIR/runtime/parser-logs" "$OUT_DIR/runtime/parser-state" "$OUT_DIR/runtime/forwarder-state" "$OUT_DIR/runtime/reference"
